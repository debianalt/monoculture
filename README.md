...
- Each political regime restructured the space through legal and fiscal instruments. Cooperatives fell from 114 creations per year to 1 following the withdrawal of registration support.
- A single digitally registered commercial form (SAS), non-existent before 2017, now dominates at 215 per year across all 17 departments.
...
| Table | Description |
|-------|-------------|
| `Table_S1_eigenvalues.csv` | MCA eigenvalues (raw + Benzecri-corrected) |
...
| `Fig2_sequence_index.png` | Sequence index plot (17 departments x 8 eras) |
| `Fig3_transition_matrix.png` | Transition probability matrix + dwell times |
...
If you use these data or code, please cite this study.
